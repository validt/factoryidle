const projectsModule = (() => {
  ...
  const projects = {
    exploration: [
      ...
      new Project("Exploration Contract 4/16", "exploration", { ironPlates: 200, redScience: 10 }, { expansionPoints: 10}),
      new Project("Exploration Contract 5/16", "exploration", { ironPlates: 300, redScience: 25 }, { expansionPoints: 10}),
      new Project("Exploration Contract 6/16", "exploration", { ironPlates: 450, greenScience: 1 }, { expansionPoints: 10}),
      new Project("Exploration Contract 7/16", "exploration", { ironPlates: 675, greenScience: 25 }, { expansionPoints: 10}),
      new Project("Exploration Contract 8/16", "exploration", { ironPlates: 1025, darkScience: 1 }, { expansionPoints: 10}),
      new Project("Exploration Contract 9/16", "exploration", { ironPlates: 1550, darkScience: 25 }, { expansionPoints: 10}),
      new Project("Exploration Contract 10/16", "exploration", { ironPlates: 2325, blueScience: 1 }, { expansionPoints: 10}),
      new Project("Exploration Contract 11/16", "exploration", { ironPlates: 3500, blueScience: 25 }, { expansionPoints: 10}),
      new Project("Exploration Contract 12/16", "exploration", { ironPlates: 5250, purpleScience: 1 }, { expansionPoints: 10}),
