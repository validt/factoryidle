...
window.researchManager.addResearch(new Research('expansionTech', 'Expansion Tech', { redScience: 4, greenScience: 4 }));
window.researchManager.addResearch(new Research('remoteConstruction', 'Remote Construction', { redScience: 12, greenScience: 12 }));
window.researchManager.addResearch(new Research('militaryTech', 'Military Tech', { redScience: 16, greenScience: 16 }));
window.researchManager.addResearch(new Research('steelMaking', 'Steel Making', { redScience: 24, greenScience: 24, darkScience: 24 }));
window.researchManager.addResearch(new Research('oilProcessing', 'Oil Processing', { redScience: 30, greenScience: 30, darkScience: 30 }));
window.researchManager.addResearch(new Research('solarTech', 'Solar Tech', { redScience: 16, greenScience: 16, darkScience: 16 }));
window.researchManager.addResearch(new Research('batteryTech', 'Battery Tech', { redScience: 16, greenScience: 16, darkScience: 16 }));
...
window.researchManager.addResearch(new Research('blueprintTech', 'Blueprint Tech', { redScience: 40, greenScience: 40, darkScience: 40, blueScience: 40 }));
window.researchManager.addResearch(new Research('clusterTech', 'Cluster Expansion', { redScience: 45, greenScience: 45, darkScience: 45, blueScience: 45 }));
window.researchManager.addResearch(new Research('trains', 'Trains', { redScience: 50, greenScience: 50, darkScience: 50, blueScience: 50 }));
window.researchManager.addResearch(new Research('trainsMax1', 'Upgrade Train Limit 2', { redScience: 60, greenScience: 60, darkScience: 60, blueScience: 60, purpleScience: 60 }));
window.researchManager.addResearch(new Research('clustersMax1', 'Upgrade Cluster Limit 3', { redScience: 60, greenScience: 60, darkScience: 60, blueScience: 60, purpleScience: 60 }));
window.researchManager.addResearch(new Research('beaconTech', 'Beacon Tech', { redScience: 100, greenScience: 100, darkScience: 100, blueScience: 100, purpleScience: 100 }));
window.researchManager.addResearch(new Research('militaryTech2', 'Armor Penetrating Ammunition', { redScience: 150, greenScience: 150, darkScience: 150, blueScience: 150, purpleScience: 150 }));
window.researchManager.addResearch(new Research('advancedElectronics2', 'Advanced Electronics II', { redScience: 150, greenScience: 150, darkScience: 150, blueScience: 150, purpleScience: 150, yellowScience: 150 }));
window.researchManager.addResearch(new Research('advancedEngineUnits', 'Advanced Engine Units', { redScience: 150, greenScience: 150, darkScience: 150, blueScience: 150, purpleScience: 150, yellowScience: 150 }));
window.researchManager.addResearch(new Research('beaconTech2', 'Beacon Tech 2', { redScience: 300, greenScience: 300, darkScience: 300, blueScience: 300, purpleScience: 300, yellowScience: 300 }));
window.researchManager.addResearch(new Research('militaryTech3', 'Piercing Ammunition', { redScience: 600, greenScience: 600, darkScience: 600, blueScience: 600, purpleScience: 600, yellowScience: 600 }));
window.researchManager.addResearch(new Research('beaconTech3', 'Beacon Tech 3', { redScience: 900, greenScience: 900, darkScience: 900, blueScience: 900, purpleScience: 900, yellowScience: 900 }));
window.researchManager.addResearch(new Research('rocketTech', 'Rocket Tech', { redScience: 150, greenScience: 150, darkScience: 150, blueScience: 150, purpleScience: 150, yellowScience: 150, whiteScience: 150 }));
window.researchManager.addResearch(new Research('gameWon', 'Win the Demo', { redScience: 4000, greenScience: 4000, darkScience: 4000, blueScience: 4000, purpleScience: 4000, yellowScience: 4000, whiteScience: 4000 }));
